...
kms_key_id = "arn:aws:kms:us-east-2:02XXXXXXXXXX6:key/XXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX"   ### Provide the ARN of KMS Key.

env = ["dev", "stage", "prod"]

################################Parameters to create ALB############################

application_loadbalancer_name = "appserver"
internal = false
...
access_log_bucket = "s3bucketcapturealblogappserver" ### S3 Bucket into which the Access Log will be captured
